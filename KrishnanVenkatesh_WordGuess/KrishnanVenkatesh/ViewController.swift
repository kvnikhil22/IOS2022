...
class ViewController: UIViewController {
    ...
    var words = [["CAMERA", "A device with lens & shutter"],
                 ["CINEMA","Art&Technology of motion-picture photography."],
                 ["FILMMAKER", "A career in movie productions."],
                 ["DIRECTOR", "control&manage a film's creative components"],
